...
import 'package:Company/app_screens/Widget/MainRowWidget.dart';
      ...
      children: [
        ...
        Text(
            formatSchedule(this.store.schedules[this.counter - 1].openingTime) +
                " - " +
                formatSchedule(
                    this.store.schedules[this.counter - 1].closingTime),
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => Ticket(
                        ServerCommunicationService.getNewUserTicket(
                            1, this.counter)))); // todo userid and counterId
          },
