...
import 'package:Company/app_screens/Card/CategoryCard.dart';
...
import 'package:Company/domain/category.dart';
...
class _CategoriesState extends State<Categories> {
  ...
  List<StoreDto> futureStores = new List<StoreDto>(5);

  @override
  void initState() {
    //futureStores = ServerCommunicationService.getAllStores();

    //Versao sem o servidor usa as proximas linhas. Apagar e pedir ao server o futureStores
    //  StoreDto sdto = new StoreDto(1, "Joao", "Rua Marques da Silva");
    //futureStores.add(sdto);
  }
            ...
            Expanded(
                child: Padding(
                    padding: EdgeInsets.symmetric(
                        horizontal: screenSize().width / 25),
                    child: null
                    /*_buildGridView(null, this.futureStores)
              ...
              press: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => CategoryCard(
                      //TODO: isto vai ser o caard dos detalhes da loja
                      stores[index].id,
                    ),
                  )),
            ));
