  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        child: Column(children: [
          Padding(padding: EdgeInsets.symmetric(vertical: screenSize().height/10),
          ...
          Padding(padding: EdgeInsets.symmetric(horizontal: screenSize().width/10, vertical: screenSize().width/10), 
          child: SignForm()),
          Row( mainAxisAlignment: MainAxisAlignment.center,
            children: [
            InkWell(
            onTap: signup,
            child: Text("Forgot password?", style: TextStyle(color: Color(0x50000000), fontSize: 18)),
            ),
            Padding(padding: EdgeInsets.symmetric(horizontal: screenSize().width/8)),
            InkWell(
              onTap: signup,
              child: Text("Sign up", style: TextStyle(color: Color(0xff13497b), fontSize: 18)),
            ),
          ])
        ])));
  }
