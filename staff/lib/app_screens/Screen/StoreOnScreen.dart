                                                ...
                                                if (_currentSliderValue == 1){
                                                  ...
                                                  _currentlabel = 'off';
                                                    Navigator.push(
                                                        context,
                                                        MaterialPageRoute(
                                                            builder: (context) => StoreOff(this.store)));
                                                                                      }
                                              });
                                            },
                                          ),),
        ...
        children: [
          Text("Current customer:",
              style: TextStyle(
                  ...
                  fontWeight: FontWeight.bold)),
          Text(
              "Number " + this.counter.currentTicketId.toString() ,
        ...
        children: [
          Text("Current customer:",
              style: TextStyle(
                  ...
                  fontWeight: FontWeight.bold)),
          Text(
              "Number " + this.store.counters[this.sector_id-1].currentTicketId.toString() ,
              style: TextStyle(color: Color(0xFF143656), fontSize: 20)),
        ...
        children: [
          Text("Average waiting time:",
              style: TextStyle(
                  ...
                  fontWeight: FontWeight.bold)),
          Text(
              (this.store.counters[this.sector_id-1].avgWaitingTime.hour * 60 +
                          this.store.counters[this.sector_id-1].avgWaitingTime.minute)
                      .toString() +
                  " minutes",
              style: TextStyle(color: Color(0xFF000000), fontSize: 20)),
        ],
  ...
  Container nextTicketButton() {
    return Container(
        ...
        child: RaisedButton(
          ...
          onPressed: () {
             this.new_counter = ServerCommunicationService.staffNextTicket(this.sector_id,this.sector_name);

              Navigator.push(
                   context,
                   MaterialPageRoute(
                     builder: (context) => StoreOn(this.store, this.sector_id, this.sector_name, this.counter_id,   play(new_counter) ) //countername:A23 counter_id : index da Padaria
                     ),);},
...
CounterDto play(Future<CounterDto> counter){
  CounterDto c;
