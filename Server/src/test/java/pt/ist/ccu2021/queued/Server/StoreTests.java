...
public class StoreTests {
    ...
    private List<ScheduleDto> scheduleDtos = new ArrayList<>(); // todo img below
    private StoreDto storeDto = StoreDto.builder().categoryId(1).counters(new ArrayList<>()).img(null).schedules(scheduleDtos)
