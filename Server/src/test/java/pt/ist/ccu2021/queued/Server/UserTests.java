...
public class UserTests {
    ...
    private UserAccount user = UserAccount.builder().firstName("Francisco").lastName("Morgado").email("franciscomanhas@gmail.com").password("asdasdasd").dateOfBirth(new Date()).build();
